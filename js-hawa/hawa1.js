/* Rename this file to hawa1.js when uploading to your website! */
function hawa1(id="hawa1",dt=5000){
    ...
    style.innerHTML="@keyframes jetakey{from{transform:perspective(400px) rotate3d(0,1,0,90deg);animation-timing-function:ease-in;opacity:0}40%{transform:perspective(400px) rotate3d(0,1,0,-20deg);animation-timing-function:ease-in}60%{transform:perspective(400px) rotate3d(0,1,0,10deg);opacity:1}80%{transform:perspective(400px) rotate3d(0,1,0,-5deg)}to{transform:perspective(400px)}}.hawa1{backface-visibility:visible;animation-name:jetakey;animation-duration:1s;animation-fill-mode:both;z-index:1000}";
    document.head.appendChild(style);set();
    function set(){logo.classList.remove("hawa1");setTimeout(function(){logo.classList.add("hawa1");},100);}
